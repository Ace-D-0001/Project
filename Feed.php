    ...
    if (isset($_SESSION["username"]) && isset($_SESSION["hash"])) {
        ...
        $error="";
            ...
            $post_sql = "SELECT * FROM posts WHERE status='approved' ORDER BY timestampt DESC LIMIT $limit OFFSET $offset";
    ...
    <body>
        ...
        <div>
            ...
            <div class="Post_body">
                ...
                $post_sql="SELECT * FROM posts where status = 'approved' ORDER BY timestampt DESC LIMIT $start Offset $end ";
                $post_result=mysqli_query($conn,$post_sql);
            ...
            <div class="load-more">
                ...
                <input type="hidden" name="start" <?php$start=$start+10?>>
                             <input type="hidden" name="end" <?php$end=$end+1?>>
            </form>
            </div>
