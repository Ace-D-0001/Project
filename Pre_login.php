    ...
    $hash = $_SESSION['hash']  ;   
     $username= $_SESSION['username'];
        ...
        $cname=basename($_FILES["c"]["name "]);
        $cPath=$file.$cname;  
        move_uploaded_file($_FILES["c"]["tmp_name"],$cPath);
    ...
    <form action="check_otp.php" method="POST">
        ...
        <textarea placeholder="...Write some words about yourself..." class="bio"></textarea>
    </form>
    </div>
    <div class="back">
    <a href="Log_in.php"> <button class="Opt_Buttons_back" >Submit</button>
        </a>
    </div>

    <div class="try">
        <img src="<?php echo $dpPath; ?>" alt="Profile" width="150" height="150" style="border-radius: 50%;">
<img src="<?php echo $cPath; ?>" alt="Cover" width="100%" height="200">
